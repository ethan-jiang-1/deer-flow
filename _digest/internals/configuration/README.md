...
| 文件 | 内容 |
|------|------|
| **01-config-yaml.md** | AppConfig 深挖：38 section、from_file() 8 步流水线、config_version 升级、🆕 memory 重构、feature gating |
...
| **04-config-reference.md** | 完整字段级配置手册：每个 section 的 YAML schema、默认值、🆕 memory.backend_config、authorization |

...
> **交叉引用：** Sandbox ABC 抽象 + 五种实现架构见 [architecture/06-sandbox.md](../../concepts/sandbox/abstract-interface-and-three-impls.md)。IT 治理视角（策略执行、审计可观测性）见 [it-ops/02-sandbox-governance.md](../it-ops/02-sandbox-governance.md)。
